        ...
        <div className="mt-13 grid grid-cols-3 gap-5 max-[900px]:grid-cols-2 max-[560px]:grid-cols-1">
          {testimonialItems.map((testimonial, index) => (
            <div
              ...
              className={`flex flex-col gap-4.5 rounded-[10px] border border-[var(--landing-border)] bg-[var(--landing-card)] px-6.5 py-7 transition-all duration-200 hover:-translate-y-[1px] hover:border-[var(--landing-border-strong)] ${
                index === 1 ? "pt-6 pb-5.5" : ""
              }`}
            >
