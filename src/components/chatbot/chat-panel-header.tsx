...
import type { ChatOperator } from "@/components/chatbot/types";
      ...
      <div className="relative z-10 flex items-center justify-between px-3 pb-2 pt-3">
        <div className="flex items-center gap-[3px] rounded-full bg-[var(--chatbot-control-bg)] p-[3px]">
          <button
            ...
            className="rounded-full bg-[var(--chatbot-surface)] px-3.5 py-1.5 text-[0.72rem] font-semibold text-[var(--chatbot-accent)] shadow-[0_2px_8px_var(--chatbot-shadow-soft)]"
          >
            Conversation
          </button>
          <button
            type="button"
            aria-label="Articles"
            className="rounded-full px-3.5 py-1.5 text-[0.72rem] font-semibold text-[var(--chatbot-on-accent-muted)] transition-colors hover:text-[var(--chatbot-on-accent)]"
          >
            Articles
          </button>
        </div>
